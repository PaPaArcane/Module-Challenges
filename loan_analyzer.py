...
print(Sum / number_of_loans)

# Or an additional input might look like:
# def Average(loan_costs)
   # return sum(loan_costs) / number_of_loans
...
discount_rate = 0.2 
Present_value = loan["future_value"] / (1 + discount_rate/12) ** loan["remaining_months"]
...
def pv(fv,nper, rate):
     present_value = fv / (1 + rate/12) ** nper
     return present_value

# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
new_loan_pv = pv(1000, 12, 0.2)
